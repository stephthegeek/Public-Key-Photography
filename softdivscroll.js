...
function SoftDivScroll(id, funcRef) /*02 Feb 2015*/
{
 ...
 this.init = function( /** DISTRIBUTION OF DERIVATIVE CODE FORBIDDEN. VISIBLE SOURCE DOES NOT MEAN OPEN SOURCE **/ )
 {
  ...
  {  
     ...
     this.ih( document, 'DOMContentLoaded', (function( inst, anch )
     { 
       return function()  
       {    
         setTimeout( function()
   ...
   this.ih( document, 'click', ( function( inst ){ return function(e){ inst.checkLink(e); } } )( this ) );
 ...
 this.checkLink = function( e )
 {
   ...
   if( srcElem && (srcElem.hash != "" || srcElem.id != "") && !/\bnosoftscroll\b/i.test( srcElem.className ) && this.samePath( srcElem.href, location.href ) )
   {
     if( this.go( srcElem.hash || srcElem.id ) )
     {
